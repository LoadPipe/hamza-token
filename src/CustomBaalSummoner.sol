...
import "./CustomBaal.sol";

contract CustomBaalSummoner is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function _summonBaal(
        ...
        (
            ...
            address _communityVault /* NEW community vault for hamza*/
        ) = abi.decode(initializationParams, (string, string, address, address, address, address, address));

        CustomBaal _baal = CustomBaal(
