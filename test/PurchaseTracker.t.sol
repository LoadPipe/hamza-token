...
contract TestPaymentAndTracker is DeploymentSetup {
    ...
    function placePayment(
        ...
        vm.startPrank(payer);
        loot.approve(address(escrow), amount);
    ...
    function releaseEscrow(PaymentEscrow escrow, bytes32 paymentId) private {
        EscrowLib.Payment memory payment = escrow.getPayment(paymentId);
